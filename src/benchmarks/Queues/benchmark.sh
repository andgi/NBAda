#!/bin/bash
# $Id: benchmark.sh,v 1.4 2008/01/11 18:48:56 andersg Exp $
# Benchmark batch job
...
PROGS="queue_test.ebmr queue_test.hpmr queue_test.lfrc queue_test.lfmr queue_test.lfmr2 queue_test.bounded"
THREADS="1 2 4 8 16"
