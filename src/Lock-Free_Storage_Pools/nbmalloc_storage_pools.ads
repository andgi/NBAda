...
-------------------------------------------------------------------------------
--                              -*- Mode: Ada -*-
--  Filename        : nbmalloc_storage_pools.ads
--  Description     : A NBmalloc based storage pool.
--  Author          : Anders Gidenstam
--  Created On      : Mon Jun 20 15:06:46 2005
--  $Id: nbmalloc_storage_pools.ads,v 1.1 2005/06/20 16:34:59 anders Exp $
-------------------------------------------------------------------------------

with System.Storage_Elements;
with System.Storage_Pools;

package NBmalloc_Storage_Pools is
   pragma Preelaborate (NBmalloc_Storage_Pools);

   ----------------------------------------------------------------------------
   type Lock_Free_Storage_Pool is
...
private
   ...
   pragma Linker_Options ("-lnbmalloc");
